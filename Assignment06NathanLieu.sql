...
-- 2024-11-14,NathanLieu,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_NathanLieu')
	 Begin 
	  Alter Database [Assignment06DB_NathanLieu] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_NathanLieu;
	 End
	Create Database Assignment06DB_NathanLieu;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_NathanLieu;
...
AS
	...
	ORDER BY InventoryDate ASC, ProductName ASC, Count DESC;
go 
...
AS
	SELECT DISTINCT TOP 100000  I.InventoryDate, E.EmployeeFirstName + ' ' + E.EmployeeLastName as EmployeeName
		FROM vEmployees AS E
			INNER JOIN vinventories AS I ON E.EmployeeID = I.EmployeeID
...
AS
	...
	ORDER BY CategoryName, ProductName, InventoryDate ASC, Count;
go 
...
AS
	SELECT TOP 100000 M.EmployeeFirstName + ' ' + M.EmployeeLastName as ManagerName, E.EmployeeFirstName + ' ' + E.EmployeeLastName as EmployeeName
		FROM vemployees AS E
...
AS
	SELECT TOP 100000
		...
		vEmployees.EmployeeID, vEmployees.EmployeeFirstName + ' ' + vEmployees.EmployeeLastName as Employee, m.EmployeeFirstName + ' ' + m.EmployeeLastName as Manager,
		...
		FROM vcategories
			...
			INNER JOIN vemployees ON vEmployees.EmployeeID = vinventories.EmployeeID
			INNER JOIN vemployees AS M ON vemployees.EmployeeID = m.ManagerID
